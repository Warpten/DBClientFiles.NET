...
namespace DBClientFiles.NET.ConsoleTests
{
    ...
    {
        [ThreadStatic]
        public static TimeSpan LambdaGenerationTime;
        ...
        // To allow for overloads with differing numbers of arguments, we flag arguments which should be        // ignored by using this Type:
        ...
        private static class InstanceCreationFactory<TArg1, TArg2, TArg3>
        {
            ...
            {
                LambdaGenerationTime = TimeSpan.Zero;
                ...
                // Get a collection of the constructor argument Types we've been given; ignore any                // arguments which are of the 'ignore this' Type:
                ...
                stopwatch.Stop();
                LambdaGenerationTime = stopwatch.Elapsed;
            }
        }
    }
}
