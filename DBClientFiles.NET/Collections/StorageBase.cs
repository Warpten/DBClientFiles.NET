...
{
    internal sealed class StorageBase<T> : IEnumerable<Proxy<T>>
    {
        ...
        public StorageBase(StorageOptions options, Stream dataStream)
        {
        ...
        public IEnumerator<Proxy<T>> GetEnumerator()
        {
